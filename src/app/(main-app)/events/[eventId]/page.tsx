            ...
            <Card className="shadow-lg">
                <CardHeader className="flex flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                        <AddReminderBtn eventId={event.id} eventTitle={event.title}
                ...
                <CardContent className="space-y-6">
                    ...
                    {
                        event.fullDay &&
                        <Badge>Full Day Event</Badge>
                    }
                    <Separator/>
                    {/* Converted to client component in order to get local time from UTC */}
                    <StartAndEndDate startTime={event.startTime} endTime={event.endTime} isFullDay={event.fullDay}/>
